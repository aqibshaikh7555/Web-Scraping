...
def scrape_page(page_number):
    ...
    url = f"https://www.flipkart.com/search?q=realme+mobile&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&page={page_number}"
...
df.to_csv('flipkart_mobile_data_4.csv', index=False, encoding='utf-8')
